...
<head>
    ...
    <title>Pregled članaka na čekanju</title>
...
<div class="navigacija">
    ...
    <div class="content">
        <div>
            <h1>Lista članaka za odobrenje</h1>
        </div>
        ...
        <div class="info-container" style="width:auto">
            <?php
                ...
                if (!isset($pronadjeniClanci)) {
                    echo "<h3>Nema članaka za odobrenje</h3>";
                }
            ?>
        </div>
    </div>
